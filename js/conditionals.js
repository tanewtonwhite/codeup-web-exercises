 ...
 * if it's 3, 35%,
 * if it's 4, 50%,
 * and if it's 5 you'll get everything for free!.
 *
 * Write a function named `calculateTotal` which accepts a lucky number and total amount,
...
//let userTotalBill = prompt('Enter your total bill amount.');
